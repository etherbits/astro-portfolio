...
export const ui = {
  en: {
    ...
    home: {
      intro_first_start: "Hello there! I'm",
      intro_first_name: "Nika",
      intro_first_end: "a",
      intro_profession: "Web Developer",
      intro_paragraph:
        "I build responsive, optimized, and inclusive web solutions utilizing leading web technologies with the goal of delivering seamless digital experiences.",
      intro_button: "View My Projects",
    },
    projects: {
      title: "My Projects",
      items: {
    ...
    contact: {
      title: "Get In Touch",
      name_label: "Name",
      name_placeholder: "Andrew Smith",
      email_label: "E-Mail",
      email_placeholder: "ExampleMail@gmail.com",
      message_label: "Message",
      message_placeholder: "I would like to get in touch...",
      button: "Send Message",
  ...
  ka: {
    ...
    home: {
      intro_first_start: "გამარჯობა! მე ვარ",
      intro_first_name: "ნიკა",
      intro_first_end: "",
      intro_profession: "ვებ დეველოპერი",
      intro_paragraph:
        "მე ვაწყობ რესპონსიულ, ოპტიმიზირებულ და ინკლუზიურ ქსელურ პროგრამებს მოწინავე ვებ ტექნოლოგიების გამოყენებით, სასიამოვნო ციფრული გამოცდილებების შესაქმნელად",
      intro_button: "ნახე ჩემი პროექტები",
    },
    projects: {
      ...
      webpage_button: "საიტის მონახულება",
      demo_button: "დემონსტრაციის ნახვა",
    },
    journey: {
      title: "ჩემი გზა",
      cards: {
    ...
    contact: {
      title: "შევხმიანდეთ",
      name_label: "სახელი",
      name_placeholder: "გიორგი ბერიძე",
      email_label: "ელ-ფოსტა",
      email_placeholder: "ExampleMail@gmail.com",
      message_label: "მესიჯი",
      message_placeholder: "მოდი შევხმიანდეთ...",
      button: "მესიჯის გაგზავნა",
      contact_info_title: "დამატებითი ინფორმაცია",
    },
  },
} as const;
